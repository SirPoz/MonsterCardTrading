...
namespace MonsterCardTrading.DAL
{
    internal class SchemaHandler
    {
        ...
        public SchemaHandler()
        {
            ...
            _schema.Add("battles", "CREATE TABLE IF NOT EXISTS battles (id SERIAL NOT NULL , winner varchar(255) NULL,  loser varchar(255) NOT NULL, lobby_id varchar(255) NOT NULL, fought_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id))");
